            ...
            <div className="detailedInfo">
              <div>
                <div className="detailedInfo">
                  ...
                  <p className="textInfo">{detailedStructure.expansion}</p>
                </div>
                <div className="detailedInfo">
                  <p className="classInfo">Type:&nbsp;&nbsp;&nbsp; </p>
                  <p className="textInfo">{detailedStructure.type}</p>
                </div>
                <div className="detailedInfo">
                  <p className="classInfo">Age:&nbsp;&nbsp;&nbsp; </p>
                  <p className="textInfo">{detailedStructure.age}</p>
                </div>
                <div className="detailedInfo">
                  <p className="classInfo">Hit Points:&nbsp;&nbsp;&nbsp; </p>
                  <p className="textInfo">{detailedStructure.hit_points}</p>
                </div>
                <div className="detailedInfo">
                  <p className="classInfo">Build Time:&nbsp;&nbsp;&nbsp; </p>
                  <p className="textInfo">
                    {detailedStructure.build_time} seconds
                  </p>
                </div>
              </div>
              <img
                className="detailedImgCiv"
                src={detailedStructure.image}
                alt={detailedStructure.name}
              ></img>
            </div>
            <div className="detailedInfo">
