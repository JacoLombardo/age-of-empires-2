            ...
            <div className="detailedInfo">
              <div>
                <div className="detailedInfo">
                  ...
                  <p className="textInfo">{detailedTechnology.expansion}</p>
                </div>
                <div className="detailedInfo">
                  <p className="classInfo">Type:&nbsp;&nbsp;&nbsp; </p>
                  <p className="textInfo">{detailedTechnology.type}</p>
                </div>
                <div className="detailedInfo">
                  <p className="classInfo">Age:&nbsp;&nbsp;&nbsp; </p>
                  <p className="textInfo">{detailedTechnology.age}</p>
                </div>
                {detailedTechnology.researched_at && (
                  <div className="detailedInfo">
                    <p className="classInfo">
                      Researched At:&nbsp;&nbsp;&nbsp;
                    </p>
                    {detailedTechnology.researched_at.map((struc, index) => {
                      return (
                        <ul key={index}>
                          <Link
                ...
                <div className="detailedInfo">
                  <p className="classInfo">Research Time:&nbsp;&nbsp;&nbsp; </p>
                  <p className="textInfo">
                    {detailedTechnology.research_time} seconds
                  </p>
                </div>
                {detailedTechnology.civilization && (
                  <div className="detailedInfo">
                    <p className="classInfo">Civilization:&nbsp;&nbsp;&nbsp;</p>
                    <Link
                      to={`/civilizations/c-${detailedTechnology.civilization}`}
                      className="textInfo"
                    >
                      {detailedTechnology.civilization}
                    </Link>
              ...
              <img
                ...
                src={detailedTechnology.image}
                alt={detailedTechnology.name}
              ></img>
            </div>
            <div className="detailedInfo">
